...
export default function LandingPageFooter() {
  ...
  return (
    <footer
      className="oui-bg-white oui-text-black oui-flex oui-flex-col"
      style={{
    ...
    >
      ...
      <div
        className="oui-flex oui-w-full oui-pb-8"
        style={{
      ...
      >
        ...
        <nav
          className={`oui-flex ${isMobile ? "oui-flex-col" : "oui-flex-row"}`}
          style={{ gap: "20px 40px" }}
        >
          {navLinks.map((link) => (
            <a
