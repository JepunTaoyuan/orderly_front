  ...
  return (
    ...
    >
      <Box className="oui-mb-6 lg:oui-mb-8">
        ...
        {/* oui-rounded-full oui-px-4 oui-font-semibold oui-border oui-bg-transparent data-[state=active]:bg-[#31275f] */}
        <ExchangeDivider />
        <Tabs
          value={withdrawTo}
        ...
        >
          ...
          >
            ...
            <QuantityInput
              classNames={{
                root: "oui-mt-[2px] oui-rounded-t-sm oui-rounded-b-xl oui-bg-base-9",
              }}
              token={sourceToken}
              value={props.showQty}
              readOnly
