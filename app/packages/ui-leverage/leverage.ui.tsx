...
export const LeverageInput: React.FC<LeverageInputProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      <Flex itemAlign="center" justify="center" className="oui-mr-4 mad3">
        <Input
          value={props.value}
          id={id}
          autoComplete="off"
          classNames={{
            ...
            root: cn(
              ...
              "oui-outline-1",
              "oui-outline-transparent",
              "focus-within:oui-outline-primary-none mad3",
            ),
          }}
...
export const LeverageFooter: FC<LeverageProps & { isMobile?: boolean }> = (
  ...
  return (
    <Flex direction={"row"} gap={2} width={"100%"} mt={0} pt={5}>
      <Button
        variant="text"
        className="oui-rounded-full oui-border oui-border-solid"
        style={{
