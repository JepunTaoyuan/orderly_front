...
export const BecomeAffiliate: FC<BecomeAffiliateReturns> = (props) => {
  ...
  return (
    <Flex
      ...
      width={"100%"}
    >
      <Text size="lg">{t("affiliate.process.title")}</Text>
  ...
  return (
    <Flex
      className={cn(
        ...
        "sm:oui-flex-1 sm:oui-flex-col sm:oui-gap-[6px]",
      )}
      width={"100%"}
    >
      ...
      <Flex
        className={cn(
          ...
          // sm
          "sm:oui-items-center sm:oui-justify-start",
        )}
      >
        <Text className="oui-text-sm md:oui-text-base 2xl:oui-text-lg sm:oui-text-center">
          {props.title}
        </Text>
        <Text className="oui-text-2xs oui-text-base-contrast-36  sm:oui-text-center">
          {props.content}
        </Text>
      </Flex>
    </Flex>
...
const ShareIcon = () => {
  return (
    <svg
      ...
      className="lg:oui-w-[64px] lg:oui-h-[64px] 2xl:oui-w-[80px] 2xl:oui-h-[80px]"
    >
      <path d="M24 33a9 9 0 1 1-18 0 9 9 0 0 1 18 0" fill="#894CD1" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  return (
    ...
    >
      <path
        ...
        fillOpacity=".36"
      />
      <path d="M45 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0" fill="#894CD1" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
