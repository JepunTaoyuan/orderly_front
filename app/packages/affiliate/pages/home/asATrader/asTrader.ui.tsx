    ...
    <Dialog open={props.open} onOpenChange={props.setOpen}>
      <DialogTrigger>
        <Button
          variant="contained"
          size="lg"
          className="oui-px-9 oui-rounded-full oui-text-base-contrast-54"
          style={{
            background:
              "linear-gradient(180deg, rgba(255, 255, 255, 0.09), rgba(153, 153, 153, 0.3))",
          }}
        >
          {t("affiliate.asTrader.button")}
        </Button>
      </DialogTrigger>
      <DialogContent className="oui-w-[320px] oui-font-semibold oui-bg-base-10">
        <DialogHeader>
