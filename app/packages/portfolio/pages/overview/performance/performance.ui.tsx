  ...
  return (
    ...
    >
      <Grid
        ...
        gap={3}
        style={{
          gridTemplateColumns: "300px 1fr", // 左側固定 300px,右側自動填充
        }}
      >
        {/* 左側:三個統計 Box 垂直排列 */}
        <Grid cols={1} gap={2}>
...
export const PerformancePnL: React.FC<{
  ...
  const { t } = useTranslation();
  return (
    <Box mb={2} height={"220px"}>
      <Text as="div" size="sm" className="oui-mb-3 oui-text-base-contrast-36">
